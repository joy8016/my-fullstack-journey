...
const fharenheit = document.getElementById('fahrenheit');
...
function computeTemp(event) {
  ...
  switch(event.target.name){
    case  "celsius":
        ...
        fharenheit.value = (currentValue * 1.8 + 32).toFixed(2);
    ...
    case "kelvin":
        ...
        fharenheit.value = ((currentValue - 273.32)*1.8+32).toFixed(2);
        break;
    default:
